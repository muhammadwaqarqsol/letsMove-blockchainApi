...
export const dashboardRouter = router({
  ...
  //       },
  //     });
  //     const totalSellerTruckerPromise = await prisma.user.count({
  //       where: {
  //         is_deleted: false,
  //         Role: {
  //           name: {
  ...
  //       activeTicketPromise,
  //       closedTicketPromise,
  //       totalSellerTruckerPromise,
  //     ]);
  //     const date = new Date().toISOString().split('T')[0];
  //     const analyticsData: any = [
  //       {
  //         title: 'Active Sellers/Buyers',
  //         data: totalSeller,
  //         symbol: '',
  //         icon: 'fas fa-users',
  //         cols: false,
  //         link: '/admin/users?type=seller_buyer',
  //       },
  //       {
  //         title: 'Active Sellers/Truckers',
  //         data: totalSellerTrucker,
  //         symbol: '',
  //         icon: 'fa-solid fa-truck-pickup',
  //         cols: false,
  //         link: '/admin/users?type=seller_trucker',
  //       },
  //       {
  ...
  //   }
  // }),
  // recentUsers: publicProcedure.query(async ({ ctx }) => {
  //   try {
  //     const token = ctx?.req?.cookies['ticketing-admin-token'];
  //     let userData;
  //     if (token) {
  ...
  //     }
  //     const recent_orders = await prisma.user.findMany({
  //       take: 5,
  //       orderBy: {
  //         created_at: 'desc',
  //       },
  ...
  //       },
  //     });
  //     return { message: 'user Data', data: recent_orders };
  //   } catch (error: any) {
  //     throw new TRPCError({
  //       code: 'INTERNAL_SERVER_ERROR',
  //       message: error?.message,
